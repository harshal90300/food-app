...
class BabaKaDhaba {
    ...
    BabaKaDhaba({this.allCategories, this.allPosts});

    BabaKaDhaba.fromJson(Map<String, dynamic> json) {
...
class AllCategories {
   ...
   static List <AllCategories> getkhana(List khana){
      return khana.map((e) => AllCategories.fromJson(e)).toList();
    }
